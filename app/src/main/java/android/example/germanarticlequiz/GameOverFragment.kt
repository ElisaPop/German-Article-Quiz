...
import android.example.germanarticlequiz.databinding.FragmentGameOverBinding
...
class GameOverFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        binding.textLoss.setText(getString(R.string.result_loss, args.numQuestions, args.numCorrect))
